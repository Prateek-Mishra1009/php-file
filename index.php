    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="assets/images/icon/stocklogo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
		...
		<?php endif ?>
		<img src="surrealism_dark_hell_stairs_4k_hd.jpg" style="width:100%;" alt="welcome " style="width:100%">
        ...
        <footer>
            <div class="footer-area">
                <p> © PROJECT BY PRATEEK MISHRA 18MCA003 (NIT AGARTALA) </p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
